...
if __name__ == "__main__":
    # PORT environment variable se port fetch karte hain, agar nahi ho toh 5000 default hai
...
BOT_TOKEN = "7571023642:AAGRIaF2tlP0dHG0868RlB8pUFoKVFEcagI"
PAYMENT_CHANNEL = "@starlinkpayment1" #add payment channel here including the '@' sign
OWNER_ID = 6972264549 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@bhediyatheater"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 5 #Put daily bonus amount here!
Mini_Withdraw = 90  #remove 0 and add the minimum withdraw u want to set
Per_Refer = 9 #add per refer bonus here
